...
export default function Landing() {
    ...
    return (
        <main
            id="main-content"
            className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 px-6 py-16"
        >
            <div className="mx-auto max-w-6xl">

                <header
                    className="mb-16 rounded-3xl bg-gradient-to-r from-blue-700 to-indigo-700 p-10 text-center text-white shadow-xl"
                >
                    <h1
                        id="landing-title"
                    ...
                    <p className="mx-auto max-w-3xl text-lg text-blue-100">
                        Real-time AI assistant for Fans, Volunteers, Organizers
                        and Venue Staff during FIFA World Cup 2026.
                    </p>
                </header>

                <section
                    aria-labelledby="landing-title"
                    aria-label="Choose your FIFA role"
